...
{
    [TestFixture]
    public class SingleThreadedTestMatcherTests
    {
        private SingleThreadedTestMatcher matcher;

        [SetUp]
        public void SetUp()
        {
            matcher = new SingleThreadedTestMatcher();
        }
        ...
        public void SingleThreadedTestMatcher_FindsTestMatchesCorrectly(List<CodeCoverage.Model.CodeCoverage> codeCoverages, List<FileChange> fileChanges)
        { 
